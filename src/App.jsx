  ...
  return (
    <main className="app">
      {goal
        ...
        : tab === 'month'
          ? <MonthView budgetId={budgetId} budget={budget} uid={user.uid} nudge={nudge} onBack={goHome} onDeleted={goHome} />
          : <HistoryView budgetId={budgetId} fixedBase={budget?.baseAmount} />}
