...
![Tests](https://img.shields.io/badge/tests-201%20%2B%20108%20rules-1baf7a?style=flat-square)
...
| **Import CSV or XLSX** | Columns are detected from the file itself, and a month of spending is classified by merchant rather than row by row. |
