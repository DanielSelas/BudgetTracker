...
const SEEDS = [
  ...
  { match: ['חשמל', 'מים', 'תקשורת', 'סלולר', 'אינטרנט'], category: 'fixed' },
  { match: ['ביטוח', 'בריאות', 'תרופ', 'רפוא'], category: 'fixed' },
  { match: ['דלק', 'תחבורה', 'חניה', 'רכב'], category: 'fixed' },
  { match: ['מסעד', 'קפה', 'בתי אוכל'], category: 'leisure' },
  { match: ['ביגוד', 'הנעלה', 'אופנה', 'שופינג', 'קניות'], category: 'leisure' },
  { match: ['פנאי', 'בידור', 'תרבות', 'ספורט', 'נופש'], category: 'leisure' },
]
