...
export default function UnplannedCard({
  ...
  return (
    <section className="cat-card" data-category="unplanned">
      ...
      {/* הרשימה מוצגת כשיש מה להציג, ולא רק כשיש יתרה. התנאי על
          היתרה הסתיר שורות קיימות: בחודש מיובא בלי הכנסה היתרה היא
          אפס, ולכן כל הוצאות הבלת״ם נעלמו מהמסך למרות שהן נספרות */}
      {(entries.length > 0 || reserve > 0) && (
